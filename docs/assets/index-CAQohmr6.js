...
<div class="menu-container">
  ...
  `,l.appendChild(e),M()}function S(){m();const e=document.createElement("div");e.innerHTML=`
  ...
  `,l.appendChild(e)}L.addEventListener("click",f);O.addEventListener("click",I);R.addEventListener("click",S);function M(){const e=document.querySelector(".carousel"),r=Array.from(document.querySelectorAll(".carousel-item"));r.forEach(a=>{const c=a.cloneNode(!0);e.appendChild(c)}),document.querySelectorAll(".carousel-item");let t=0,n=!1,s=0,i=0,d=0,o;function v(){i=-t*100,e.style.transition="transform 0.5s ease-in-out",e.style.transform=`translateX(${i}%)`,setTimeout(()=>{t>=r.length&&(e.style.transition="none",t=0,i=0,e.style.transform="translateX(0%)",d=0)},500)}function C(){t++,v(),d=-t*100}function p(){o=setInterval(()=>{n||C()},3e3)}function u(a){n=!0,s=a.type.includes("touch")?a.touches[0].clientX:a.clientX,clearInterval(o),e.style.transition="none"}function E(a){if(!n)return;const h=(a.type.includes("touch")?a.touches[0].clientX:a.clientX)-s;i=d+h/e.offsetWidth*100,e.style.transform=`translateX(${i}%)`}function A(a){if(!n)return;n=!1,e.style.transition="transform 0.5s ease-in-out";const c=i-d;c<-20?t++:c>20&&t>0&&t--,v(),d=-t*100,p()}e.addEventListener("mousedown",u),e.addEventListener("mousemove",a=>{n&&E(a)}),window.addEventListener("mouseup",A),e.addEventListener("touchstart",u,{passive:!1}),e.addEventListener("touchmove",E,{passive:!1}),e.addEventListener("touchend",A),document.querySelectorAll(".carousel-item img").forEach(a=>{a.addEventListener("dragstart",c=>c.preventDefault())}),p()}document.addEventListener("DOMContentLoaded",M);I();
